...
import 'package:zeyad_ali_portfolio/widgets/custom_widgets/tablet_my_skills_item.dart';
import 'package:zeyad_ali_portfolio/widgets/custom_widgets/section_header.dart';

class DesktopMySkillsSection extends StatelessWidget {
  const DesktopMySkillsSection({super.key});
        ...
        children: [
          ...
          Wrap(
            ...
            children: List.generate(
              mySkills.length,
              (int index) {
                return TabletMySkillsItem(model: mySkills[index]);
              },
            ),
          ),
          const SizedBox(height: Constants.kDesktopVerticalPadding),
